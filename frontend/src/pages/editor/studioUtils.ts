...
export function defaultDailyArtboard(): ArtboardDoc {
  ...
  return {
    ...
    compose: {
      ...
      title: '运营日报',
      text_before:
        '<p><strong>【{{院区}}】运营日报</strong></p><p>以下为今日核心指标：</p>',
      text_after: '<p>数据来源：数据推送中台 · 仅供内部参考</p>',
    },
  }
}
...
export function defaultAlertArtboard(): ArtboardDoc {
  return {
    ...
    compose: {
      ...
      title: '指标告警',
      text_before:
        '<p>⚠ <strong style="color: rgb(255, 77, 79);">指标告警</strong></p><p>监测到异常，请关注：</p>',
      text_after: '<p>告警由数据推送中台自动生成</p>',
    },
  }
}
